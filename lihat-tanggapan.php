...
<div class="main">
	...
	echo "<div class='alert alert-danger'>Pengaduan ini belum ditanggapi.</div>";
	}else{
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="work-details">
                  <h5 class="work-details-title font-alt">Tanggapan</h5>
                  <p><?=$data['tanggapan']?></p>
                  <ul>
                    <li>
                      <span class="font-serif"><?=$data['tgl_tanggapan']?></span>
                    </li>
                    <li>
                      <span><a href="?url=lihat-pengaduan"><strong>Kembali</strong></a></span>
                    </li>
        ...
        <div class="module-small bg-primary" id="bawah">
          <div class="container-fluid">
            <div class="row">
              ...
              <li><a href="tulis-pengaduan.php">Tulis Laporan</a></li>
              <li><a href="lihat-pengaduan.php">Lihat Pengaduan</a></li>
                  </ul>
                </div>
              </div>
            </div>
